...
pub(crate) fn builtin_coding_workflow_projection() -> Value {
    json!({
        ...
        "model_protocol": {
            ...
            "normal_closeout": "Source/validation/unresolved Session evidence: finish_coding_task(summary_only=true). Pure read/planning/investigation/artifact: finalize directly unless project rules require closeout."
        },
        "roles": {
            "independent_review": {
