...
export function productNode(tag, text = "", className = "") {
    const node = document.createElement(tag);
    node.textContent = text;
    node.className = className;
    return node;
}
export function productButton(label, action, className = "btn secondary") {
...
export function productTime(timestamp, language, now = Date.now()) {
...
export function createProductProjectRow(project, options) {
...
export function productDialog(title, language) {
